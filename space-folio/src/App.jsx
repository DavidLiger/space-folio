...
export default function Scene() {
  ...
  const handleVaisseauClick = () => {
    ...
    // setPlanetClickedName("Vaisseau");
    // // Logique pour le vaisseau, par exemple, ouvrir une modale ou lancer une animation
    // setModaleOpen(true);
    // setModaleContent({ title: "Vaisseau", content: "Vous avez cliqué sur le vaisseau." });
  };
